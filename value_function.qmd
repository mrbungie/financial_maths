...
| Time | Cashflow | Type    | Description |
|------|----------|---------|-------------|
| 0    | −100     | Outflow | Investment  |
| 1    | +50      | Inflow  | Return      |
| 2    | +60      | Inflow  | Return      |
...
% Outflow at t=0
\draw[->,red!70!black,very thick] (0,0.5) -- (0,-1.2);
\node[above,red!70!black] at (0,0.7) {−\$100};
\node[below,red!70!black,font=\tiny] at (0,-1.5) {Invest};

% Inflow at t=1
\draw[->,green!60!black,very thick] (5,-1) -- (5,0.5);
\node[above,green!60!black] at (5,0.7) {+\$50};
\node[below,green!60!black,font=\tiny] at (5,-1.3) {Receive};

% Inflow at t=2
\draw[->,green!60!black,very thick] (10,-1) -- (10,0.5);
\node[above,green!60!black] at (10,0.7) {+\$60};
\node[below,green!60!black,font=\tiny] at (10,-1.3) {Receive};

% Interest rate label
\node[font=\small,blue] at (5,1.5) {Interest rate: 5\% per period};
\end{tikzpicture}
\end{figure}
```
