...
## Teacher's Notation: Bridging Two Worlds

::: {.callout-note icon="true"}
## Two Ways to Think About Financial Mathematics

Your professor uses **value function notation** $V(t)$, while most textbooks use **classical formulas** (PV, FV, NPV). They're saying the same thing, just in different languages. Here's how they connect:
:::
...
### Teacher's Approach (Value Function)

Your professor introduces **one unified framework** that encompasses all of these:
...
| Classical Formula | Value Function Equivalent | When They're the Same |
|-------------------|---------------------------|----------------------|
| **PV** | $V(0)$ | Present value = value function at time 0 |
| **FV** | $V(T)$ | Future value = value function at final time T |
| **NPV** | $V(0)$ | NPV = value function at decision time (t=0) |

**Key insight**: The classical formulas are just **special cases** of the value function:
- PV and NPV are $V(t)$ evaluated at $t=0$
